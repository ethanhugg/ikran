...
//#if defined(_CHROME_64)
//#undef My_Test::uint64
//#endif
...
// MultiByteToWideChar().
std::wstring SysMultiByteToWide(const StringPiece& mb, i32Bit::uint32 code_page);
std::string SysWideToMultiByte(const std::wstring& wide, i32Bit::uint32 code_page);
