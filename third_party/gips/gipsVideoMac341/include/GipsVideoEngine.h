...
public:
    ...
    virtual int GIPSVideo_SetSendTOS(int channel, int TOS) = 0;
    virtual int GIPSVideo_GetSendTOS(int channel, int& TOS) = 0;
    virtual int GIPSVideo_SetSendGQOS(int channel, bool enable, int servicetype) = 0;
    virtual int GIPSVideo_GetSendGQOS(int channel, bool& enable, int& servicetype) = 0;
