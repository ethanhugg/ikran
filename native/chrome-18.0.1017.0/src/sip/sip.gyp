  ...
  'targets': [
    ...
    #
    {
      ...
      'include_dirs': [
        ...
        '../third_party/webrtc/voice_engine/main/interface',
      ],	
      ...
      'conditions': [
        ['OS=="linux"', {
          'include_dirs': [
            './third_party/libxml2/include',
            './third_party/gips/gipsVideoLinux351/include',
          ],
        ...
        ['OS=="win"', {
          'include_dirs': [
            './third_party/libcurl/include_win32',
            './third_party/gips/gipsVideo3.4.8/include',
          ],		
          'defines': [
            'SIP_OS_WINDOWS',
            'WIN32', 
        ...
        ['OS=="mac"', {
          'include_dirs': [
            './third_party/libxml2/include_darwin',
          ],
          'defines': [
            'SIP_OS_OSX',
            'OSX', 
