...
SHARED_LIBRARY_LIBS += \
	...
	$(call EXPAND_LIBNAME_PATH,signaling_sipcc,$(DEPTH)/media/webrtc/signaling/signaling_sipcc) \
	$(call EXPAND_LIBNAME_PATH,signaling_ecc,$(DEPTH)/media/webrtc/signaling/signaling_ecc) \
        $(MKSHLIB_UNFORCE_ALL) \
